               ...
               <ul class=column>
                ...
                <?php
                   ...
                   if(($client_category_id == 1)||($client_category_id == 2)||($client_category_id == 3)){
                        echo '<li><a id="ST1" href="userStatistics.php"><b>Your Reading Statistics</b></a> </li>
                        <li><a id="ST1" href="userBalance.php"><b>Your balance</b></a> </li>';
                    }
                    ...
                    if($client_category_id == 1){    
                        echo '<li><a id="LI1" href="searchPeople.php"><b>Search Users</a> </li>
                         ...
                         <li><a id="LI5" href="withdrawReturn.php">Withdraw/Return Books</a> </li>
                         <li><a id="LI6" href="libraryStatistics.php">Library Statistics</b></a> </li>';  
                    }
                ?>
              </ul>
            </td>
