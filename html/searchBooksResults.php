...
<?php
    ...
    function get_post($conn, $var)
    {
        ...
        $availablity = get_post($conn, 'availablity');
            ...
            if (strcmp($shelf_loc,"Any")!=0) {
                $query    = $query." AND b.shelf_loc like '%$shelf_loc%'";
            }else{
                $query    = $query." AND 1=1";
            }
            ...
            if ($book_id != 0){
                $query    = $query." AND b.book_id like $book_id";
            }else{
                $query    = $query." AND 1=1";
            }
                    ...
                    <h4>
                        ...
                        <?php 
                            foreach($result as $rows){
                                ...
                                if(($client_category_id ==1)&&(strcmp($availablity, "Withdrawn")==0)){
